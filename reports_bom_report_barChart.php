...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawAppStatusChart() {
        ...
        var chart = new google.visualization.BarChart(document.getElementById('appStatusChart'));
      ...
      function drawCmpStatusChart() {
        ...
        var chart = new google.visualization.BarChart(document.getElementById('cmpStatusChart'));
      ...
      function drawRequestStatusChart() {
        ...
        var chart = new google.visualization.BarChart(document.getElementById('requestStatusChart'));
      ...
      function drawRequestStepStatusChart() {
        ...
        var chart = new google.visualization.BarChart(document.getElementById('requestStepChart'));
